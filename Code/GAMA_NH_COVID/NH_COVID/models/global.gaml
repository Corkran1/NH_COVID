...
//		write Schedule;
	...
	reflex SaveResults when: ExportResults{
		save [cycle, I, E, S_r, I_r, I_s, E_s, H, Cumulative_I_r, Cumulative_I_s, Cumulative_H, D, Tests_r, Tests_s] to: "../results/" + "/EC/EpiCurve" + int(seed) +".csv" type:"csv" rewrite:false;
	}
