...
global{
	 ...
	 * 1 = Reduced activities (No communal dinning, np recreation activities), long distance visits.
	 */
	 int Scenario <- 1;
	...
	map<string, float> StaffDistribution <- ['CN'::0.6, 'LPN'::0.15, 'RN'::0.1, 'PT'::0.05]; // Distribution of staff by type [CN, LPN, RN, PT]
	...
	map<int, float> PPH_LPN <- ([0::0.15, 2::0.2, 3::0.25, 4::0.2, 5::0.2]); // Distribution of patients per hour for LPN
