...
ggarrange(CumI_p, EpiL_p, nrow = 2, common.legend = T) %>%
  annotate_figure(text_grob("Vaccine Distribution Low Community Transmission", color = "grey20", face = "bold", size = 14))  
# %>%
...
ggarrange(CumI_p, EpiL_p, nrow = 2, common.legend = T) %>%
  annotate_figure(text_grob("Vaccine Distribution High Community Transmission", color = "grey20", face = "bold", size = 14)) 
# %>%
